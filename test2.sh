...
if docker-compose exec -T dbt /home/dbt/.local/bin//home/dbt/.local/bin/dbt-yamer yaml -s stg_customers; then
...
if docker-compose exec -T dbt /home/dbt/.local/bin//home/dbt/.local/bin/dbt-yamer yaml -s stg_customers stg_orders; then
...
echo ""
echo "=============================================="
print_success "🎉 /home/dbt/.local/bin/dbt-yamer Docker Test Environment is ready!"
echo ""
